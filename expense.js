...
function saveToCrud(event) {
    ...
    axios.post("https://crudcrud.com/api/ac0b456249dd45119466c357783af688/studentData",obj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get("https://crudcrud.com/api/ac0b456249dd45119466c357783af688/studentData")
    .then((response)=>{
...
function deleteExpense(id) {
    axios.delete(`https://crudcrud.com/api/ac0b456249dd45119466c357783af688/studentData/${id}`)
